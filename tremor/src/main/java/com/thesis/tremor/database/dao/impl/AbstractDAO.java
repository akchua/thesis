...
import com.thesis.tremor.database.dao.DAO;
import com.thesis.tremor.database.dao.base.SpringHibernateDAOSupport;
 ...
 * 
 * @see DAO
 * @see com.thesis.tremor.database.dao.base.AbstractDAO
...
public abstract class AbstractDAO<T extends BaseID<ID>, ID extends Serializable>
		extends com.thesis.tremor.database.dao.base.AbstractDAO<T, ID>
		implements DAO<T, ID>
{
